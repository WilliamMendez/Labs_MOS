...
@authors: Daniel Aguilera & William Mendez
"""
...
for i in iteraciones:
    valorIter1=5-5*i/(numIteraciones-1)
...
for k in w2_vec:
    try:
        ...
        Model.f1Constraint=Constraint(expr=Model.f1<=k)
        ...
        print('No se pudo encontrar solucion para w2=',w2)
        break
    #end for
